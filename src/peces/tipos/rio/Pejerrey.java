...
public class Pejerrey extends Carnivoro {
    ...
    /**
     * Constructor de la clase Pejerrey con valores personalizados.
     *
     * @param sexo        El sexo del pez, true para macho, false para hembra.
     ...
     */
    public Pejerrey(boolean sexo, int edad, boolean vivo, boolean fertil, int ciclo, boolean alimentado) {
        super(sexo, edad, vivo, fertil, ciclo, alimentado, AlmacenPropiedades.PEJERREY);
    }
